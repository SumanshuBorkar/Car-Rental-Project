...
export default function EditCarDetails(){
 ...
 function SubmitEditForm(e){
      ...
      fetch(`https://car-rental-project-rkwz.onrender.com/cars/${edit._id}` , {
        method:"PUT",
        headers:{
          ...
          { file? <div id="imgs-add-car-container">
                 ...
                 <div className="img-sort-box">
                   ...
                   <div className="img-sort-box">
                      ...
                      <img src={`https://car-rental-project-rkwz.onrender.com/cars/${edit.image}`} id="preview-img-of-the-file" ></img>
