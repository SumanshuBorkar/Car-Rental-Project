...
const Proceed = () => {
   ...
   fetch("https://car-rental-project-rkwz.onrender.com/orders",{
   method:"POST",
   headers:{
          ...
          <div className="upper">
            ...
            <div className="comp">
               ...
               <div className="image-of-car-in-rental-payment">
                   <img src={`https://car-rental-project-rkwz.onrender.com/cars/${CarData.image}`} alt="not availble"  className='img'/>
               </div>
            </div>
          </div>
